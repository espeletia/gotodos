...
func newTodosTableImpl(schemaName, tableName, alias string) todosTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, UserIDColumn, TitleColumn, CompletedColumn}
		mutableColumns  = postgres.ColumnList{UserIDColumn, TitleColumn, CompletedColumn}
	)
